...
export const MyFabricComponent = () => {
        ...
        if (canvasEl.current) {
            ...
            canvas.current.on('object:modified', function (e) {
                ...
                if (e.target.type === 'table') {
                    canvas.current.bringToFront(e.target);
                } else {
                    canvas.current.sendToBack(e.target);
                }
                sendLinesToBack();
            });
    ...
    function addRect() {
        ...
        canvas.current.setActiveObject(o);
        objId.current++;
        return g;
    }
